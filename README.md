...
* **Add a dial:** Add a potentiometer (dial resistor) to let you adjust exactly how
* dark the room needs to be before the light turns on.
...
![Finished project](IMG-20260921-WA0015(1).jpg)
